...
group.add_argument('-g', '--ground-truth', help="if to remove that char from the ground-truth files.",
                   action="store_true")
group.add_argument('-p', '--predicted', help="if to remove that char from the predicted objects files.",
                   action="store_true")
